    ...
    tooltip: {
      ...
      formatter: function(params) {
        ...
        if (dataItem) {
          ...
          if (k > d && data[data.indexOf(dataItem) - 1]?.kdj_k <= data[data.indexOf(dataItem) - 1]?.kdj_d) {
            html += `<div style="color: #22c55e; margin-top: 4px">📈 金叉形成</div>`;
          } else if (k < d && data[data.indexOf(dataItem) - 1]?.kdj_k >= data[data.indexOf(dataItem) - 1]?.kdj_d) {
